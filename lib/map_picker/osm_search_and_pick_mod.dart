...
import 'package:blood/map_picker/widgets/wide_button.dart';
...
class _OpenStreetMapSearchAndPickState
  ...
  // Future _fetchHospitals(double lat, double lon) async {
  //   List<Hospital> hospitalList = await fetchHospitals(lat, lon, 5);
  //   setState(() {
  ...
  void initState() {
    ...
    // _fetchHospitals(widget.center.latitude, widget.center.longitude);
